...
async function getAccessToken() {
    ...
    if (!accessToken) {
        ...
        if (!code) {
            ...
            window.location.href = 'https://secure.meetup.com/oauth2/authorize?client_id=a5treomdjoc81ed63kvvuha2qi&response_type=code&redirect_uri=https://veronikahar.github.io/meetup/';
            return null;
        }
...
async function getOrRenewAccessToken(type, key) {
    ...
    if (type === 'get') {
        ...
        url = 'https://g9yh3hepyb.execute-api.us-east-1.amazonaws.com/dev/api/token/'
            + key;
    } else if (type === 'renew') {
        // Lambda endpoint to get token by refresh_token
        url = 'https://g9yh3hepyb.execute-api.us-east-1.amazonaws.com/dev/api/refresh_token/'
            + key;
    }
